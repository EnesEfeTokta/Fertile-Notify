...
namespace FertileNotify.Infrastructure.Migrations
{
    ...
    [Migration("20260424104552_AddSubscriberServiceAccountFields")]
    partial class AddSubscriberServiceAccountFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FertileNotify.Domain.Entities.AutomationWorkflow", b =>
                {
                    ...
                    b.Property<int>("CurrentRepeatCount")
            ...
            modelBuilder.Entity("FertileNotify.Domain.Entities.PaymentLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FertileNotify.Domain.Entities.SystemNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SubscriberId", "IsRead");
