...
export default function ApiReferencePage() {
    return (
        <InfoPageLayout
            badge="API"
            title="API Reference"
            subtitle="Complete reference for the Fertile Notify REST API. Base URL: https://api.fertile-notify.shop/v1"
        >
            {/* Auth note */}
            <div className="card p-5 mb-10 flex gap-4 items-start border-l-2 border-accent-primary">
                ...
                <div>
                    ...
                    <p className="text-sm text-secondary">
                        ...
                        Create API keys in the <a href="/dashboard" className="text-accent-primary hover:underline">Dashboard</a>.
                    </p>
                </div>
            </div>
