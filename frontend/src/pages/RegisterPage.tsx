                        ...
                        <div className="space-y-4 animate-[fadeIn_0.2s_ease]">
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1.5">
                                    ...
                                    <span className={`text-[10px] font-medium ${companyDescription.length >= 500 ? 'text-red-500' : 'text-tertiary'}`}>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-tertiary hover:text-primary transition-all duration-200"
