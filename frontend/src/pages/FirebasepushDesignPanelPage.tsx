...
export default function FirebasepushDesignPanelPage() {
    const navigate = useNavigate();
    const location = useLocation();

    // State initialization from location state (for new or existing templates)
    const [channelId] = useState<string>('firebasepush');
    ...
    const channelInfo = getChannelMetadata('firebasepush');
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col bg-[#050505] overflow-hidden relative">
                    ...
                    <div className="flex-1 flex items-center justify-center p-8 bg-black relative">
                        {/* Android Screen background mockup */}
                        ...
                        <div className="relative w-full max-w-[340px] -mt-32">
                            <div className="bg-[#f2f2f2] rounded-2xl shadow-2xl overflow-hidden flex flex-col font-sans">
                                {/* Android Notification Header */}
                                <div className="px-4 pt-3 pb-1 flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-gray-500">
                                        <div className="w-5 h-5 rounded-full bg-[#FFCA28] flex items-center justify-center text-white text-[10px] overflow-hidden">
                                            {channelInfo.icon}
                                        </div>
                                        <span className="text-[11px] font-medium tracking-wide">Fertile Notify</span>
                                    </div>
                                ...
                                <div className="px-4 pb-4">
                                    {title && (
                                        <div className="text-gray-900 font-bold text-[14px] mb-0.5 leading-tight break-words">
                                            {title}
                                        </div>
                                    )}
                                    <div className="text-gray-600 text-[13px] leading-snug whitespace-pre-wrap break-words">
                                        {message || 'Your Android push notification content will appear here...'}
                                    </div>
                                </div>
                            </div>
                        </div>
